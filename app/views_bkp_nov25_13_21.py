...
def find_negative_nodes(uplist):
	random_bucket = random.randint(0, len(uplist)-3)
...
def load_interface1(name='Stranger'):
	...
	while negative_nodes_list == []:
		...
		negative_nodes_list = find_negative_nodes(uplist)
	print "Choices for negative buckets: " + '||'. join(negative_nodes_list)
